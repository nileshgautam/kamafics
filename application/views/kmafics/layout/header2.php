...
<!-- Mirrored from thewebmax.com/industro/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Apr 2020 05:27:20 GMT -->
                        ...
                        <div class="logo-header">
                            <div class="logo-header-inner logo-header-one">
                                <a href="<?php echo base_url('home') ?>">
                                    <img class="logo-h-50" src="<?php echo base_url('assets/') ?>images/logo-dark.png" alt="" />
                                </a>
                            </div>
                        </div>
