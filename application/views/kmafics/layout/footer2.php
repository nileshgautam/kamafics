  ...
  <footer class="site-footer footer-large footer-dark text-white footer-style1">
      ...
      <div class="footer-top bg-no-repeat bg-bottom-right" style="background-image:url(<?php echo base_url('assets/images/background/footer-bg.png') ?>)">
          <div class="container">
              <div class="row">
                      ...
                      <div class="footer-h-left">
                          ...
                          <div class="widget recent-posts-entry">
                              <ul class="widget_address">
                                  ...
                                  <li> <i class="fa fa-phone"></i><?php echo PHONE ?>
                                  </li>
                              </ul>
                          </div>
  ...
  <div class="contact-slide-hide bg-cover bg-no-repeat" style="background-image:url(<?php echo base_url('assets/images/background/bg-7.jpg') ?>)">
      <div class="contact-nav">
          ...
          <div class="contact-nav-form">
              <div class="contact-nav-info bg-white p-a30 bg-center bg-no-repeat" style="background-image:url(<?php echo base_url('assets/images/background/bg-map2.png') ?>);">
                  <div class="row">
                      <div class="col-lg-4 col-md-4">
                          <div class="contact-nav-media-section">
                              <div class="contact-nav-media">
                                  <img src="<?php echo base_url('assets/images/self-pic.png') ?>" alt="">
                              </div>
                          </div>
                      </div>
  ...
  <!-- Mirrored from thewebmax.com/industro/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Apr 2020 05:30:15 GMT -->
