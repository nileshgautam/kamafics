                      ...
                      <div class="stamp col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b30">
                          <div class="project-stamp-list bg-white">
                              <div class="filter-wrap">
                                  <ul class="filter-navigation masonry-filter text-uppercase font-weight-bold">
                                      ...
                                      <li><a data-filter=".cat-2" href="javascript:;"><i class="" aria-hidden="true"></i>Metallurgy</a></li>

                                      <li><a data-filter=".cat-3" href="javascript:;"><i class="" aria-hidden="true"></i>Musical Equipment</a></li>

                                      <li><a data-filter=".cat-4" href="javascript:;"><i class=''></i>Solar Energy </a></li>

                                      <li><a data-filter=".cat-5" href="javascript:;"><i class=""></i>Sports Equipment</a></li>

                                      <li><a data-filter=".cat-6" href="javascript:;"><i class=""></i>Tobacco</a></li>

                                      <li><a data-filter=".cat-7" href="javascript:;"><i class=""></i>Telecommunication</a></li>

                                      <li></li>
                                  </ul>

                                  <a href="<?php echo base_url('industries') ?>" class="know-more"><i class=""></i>Know more</a>
                              </div>
                          </div>
                      </div>
                      <!-- COLUMNS 2 -->
                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 class="site-text-primary">Milestone</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->
                        ...
                        <div class="row align-items-center justify-content-end how-it-works d-flex">
                            ...
                            <div class="col-4 text-center">
                                ...
                                <div class="service-border-box">
                                    ...
                                    <span class="s-title-one">Year 1987</span>
